        ...
        for(int tc=1;tc<=t;tc++)
        {
            ...
            for(int i=3;i<=n;i++)
            {
                if(st[i]!=st[i-1])
                {
                    ...
                    {
                        if(st[i]>=et[i-2] && last==0 && st[i]>=etdj)
                        {
                            c[i]='J';
                            last=1;
                            etdj=et[i];
                        }
                        else if(st[i]>=et[i-2] && last==1 && st[i]>=etdc)
                        {
                            c[i]='C';
                            last=0;
                            etdc=et[i];
                ...
                else
                {
                    ...
                    {
                        if(st[i]>=et[i-2] && last==1 && st[i]>=etdc)
                        {
                            c[i]='C';
                            last=0;
                            etdc=et[i];
                        }
                        else if(st[i]>=et[i-2] && last==0 && st[i]>=etdj)
                        {
                            c[i]='J';
                            last=1;
                            etdj=et[i];
